...
public class Lab6 extends GLJPanel implements GLEventListener  {
    ...
    void piramidka(GL2 gl2, float r,float h) {
        ...
        for(int i = 1 ; i<=7;i++) {
            xPoints[i - 1] = (float) (r * Math.sin((2 * Math.PI / 7) * i));
            yPoints[i - 1] = (float) (r * Math.cos((2 * Math.PI / 7) * i));
        }
        gl2.glPushMatrix();
        float[] gray = { 0.6f, 0.6f, 0.6f, 1 };
        gl2.glPushMatrix();
        gl2.glRotatef(360/7,0,1,0);
        gl2.glMaterialfv(GL2.GL_FRONT_AND_BACK, GL2.GL_AMBIENT_AND_DIFFUSE,new float[]{materials[10][0],materials[10][1],materials[10][2],materials[10][3],materials[10][4],materials[10][5]}, 0);
        ...
        gl2.glPushMatrix();
        gl2.glRotatef(360/7,0,1,0);
        gl2.glMaterialfv(GL2.GL_FRONT_AND_BACK, GL2.GL_AMBIENT_AND_DIFFUSE,new float[]{materials[4][0],materials[4][1],materials[4][2],materials[4][3],materials[4][4],materials[4][5]}, 0);
        gl2.glMaterialfv(GL2.GL_FRONT_AND_BACK, GL2.GL_SPECULAR,new float[]{materials[4][6],materials[4][7],materials[4][8]}, 0);
        ...
        gl2.glMaterialfv(GL2.GL_FRONT_AND_BACK, GL2.GL_SPECULAR,new float[]{materials[13][6],materials[13][7],materials[13][8]}, 0);
        ...
        gl2.glMaterialfv(GL2.GL_FRONT_AND_BACK, GL2.GL_SPECULAR,new float[]{materials[0][6],materials[0][7],materials[0][8]}, 0);
        ...
        scianka(gl2,xPoints[6], yPoints[6],0,0, xPoints[0], yPoints[0],h);
        gl2.glPopMatrix();
    }
